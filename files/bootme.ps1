...
# This script installs puppet 3.x and deploy the manifest using puppet apply -e "include demo_mco_middleware"
# Usage:
# <powershell>
# Set-ExecutionPolicy Unrestricted -Force
# icm $executioncontext.InvokeCommand.NewScriptBlock((New-Object Net.WebClient).DownloadString('https://raw.githubusercontent.com/relybv/demo_mco_middleware/master/files/bootme.ps1')) -ArgumentList ("demo_mco_middleware")
#</powershell>


  param(
    [string]$role = "demo_mco_middleware",
  )

  $puppet_source = "https://github.com/pgomersbach/demo-mco-middleware.git"
