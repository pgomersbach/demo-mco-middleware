#!/usr/bin/env bash
#
# This script installs puppet 3.x or 4.x and deploy the manifest using puppet apply -e "include demo-mco-middleware"
#
# Usage:
# Ubuntu / Debian: wget https://raw.githubusercontent.com/pgomersbach/demo-mco-middleware/master/files/bootme.sh; bash bootme.sh
#
# Red Hat / CentOS: curl https://raw.githubusercontent.com/pgomersbach/demo-mco-middleware/master/files/bootme.sh -o bootme.sh; bash bootme.sh
...
# get or update repo
if [ -d /root/demo-mco-middleware ]; then
  echo "Update repo"
...
# install puppet
bash /root/demo-mco-middleware/files/bootstrap.sh $PUPPETMAJOR
...
cp -a /root/demo-mco-middleware/spec/fixtures/modules/* $MODULEDIR

echo "Run puppet apply"
/usr/local/bin/puppet apply -e "include demo_mco_middleware"
